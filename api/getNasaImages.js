export default async function handler(request, response) {
    ...
    try {
        ...
        const data = await apiResponse.json(); // Use type assertion
...
//# sourceMappingURL=getNasaImages.js.map