...
export default async function handler(request: VercelRequest, response: VercelResponse) {
  ...
  try {
    ...
    const descriptions = {
      ...
      mars: "Mars, the fourth planet from the Sun, is known as the Red Planet due to iron oxide (rust) prevalent on its surface. This cold desert world has captivated human imagination for centuries with its Earth-like seasons and rotation period. Mars features some of the most impressive geological features in our solar system, including Olympus Mons—the largest volcano in the solar system, rising 22km above the surrounding plains—and Valles Marineris, a canyon system that would stretch from New York to California if placed on Earth. The planet has two small, irregularly shaped moons, Phobos and Deimos, likely captured asteroids. Did you know? Mars experiences massive dust storms that occasionally engulf the entire planet, sometimes lasting for months!",
      
      jupiter: "Jupiter, the fifth planet from the Sun, is a gas giant and the largest planet in our solar system—so massive that all other planets could fit inside it more than twice over. Its iconic appearance features colorful bands of clouds and the Great Red Spot, a storm system larger than Earth that has been raging for at least 400 years. Jupiter's atmosphere is primarily hydrogen and helium, similar to the Sun's composition. With at least 79 known moons, Jupiter's four largest—Io, Europa, Ganymede, and Callisto—were discovered by Galileo in 1610. The planet's powerful magnetic field is 14 times stronger than Earth's and creates intense radiation belts. Did you know? Jupiter rotates faster than any other planet, completing a day in just under 10 hours despite its enormous size!",
      
      saturn: "Saturn, the sixth planet from the Sun, is renowned for its spectacular ring system spanning up to 175,000 miles (282,000 km) across but only about 30 feet (10 meters) thick in most places. This gas giant is composed primarily of hydrogen and helium, with a density so low that it would float in water if there were an ocean large enough to hold it. Saturn's hexagonal cloud pattern at its north pole remains one of the solar system's most puzzling features, spanning wider than two Earths. The planet hosts at least 83 moons, with Titan being the second-largest moon in our solar system and the only moon with a substantial atmosphere. Did you know? Saturn's rings are not solid but consist of countless ice particles ranging from microscopic dust to house-sized chunks, orbiting at speeds of nearly 70,000 mph!",
